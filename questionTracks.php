...
<body class = "container-sm neon-border">
    ...
    <div class = "container-sm div_reg ">
        <form class = "d-flex form" method="post" id = 'formRegistration' name="formRegistration" enctype="multipart/form-data">
            <div class="mb-3">
                <h4>Хотите ли вы добавить ещё один трек на ваш альбом?</h4>
            </div>
            <div>
                <a class = "btn btn-primary" href="add_track_to_album.php">Да</a>
                <a class = "btn btn-primary" href="question.php">Нет</a>
            </div>
        </form>
