...
<body class="container-sm neon-border">
    <?php
        ...
        $track_id = $arr['id'];
        $result = $mysqli->query("SELECT trackname FROM tracks WHERE `id` ='$track_id'");
    ...
    <div class="container-sm div_reg">
        <form id="uploadForm" class="h-100 d-flex align-items-center justify-content-center form" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="trackName" id="trackName" value = "<?= $trackname ?>"required>
            </div>
