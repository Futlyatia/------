...
<body class = "container-sm neon-border">
    ...
    <div class = "container-sm div_reg ">
        <form class = "d-flex form" method="post" id = 'uploadForm' name="uploadForm" enctype="multipart/form-data">
            ...
            <input type="text" class="form-control" name="id" id="id" value = "<?= $track_id ?>"required>
            </div>
            <div class="mb-3">
                <h4>Вы точно хотите удалить трек</h4>
            </div>
            <div>
                <button type="button" class="btn btn-primary" onclick="delete_track()">Да</button>
    ...
    <script type="text/javascript" src="scripts/delete_track_script.js"></script>
</body>
</html>